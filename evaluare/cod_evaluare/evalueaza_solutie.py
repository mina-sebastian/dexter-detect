...
def eval_detections(detections, scores, file_names, ground_truth_path):
    ...
    ground_truth_file_names = np.load(ground_truth_path + "file_names_all_faces.npy",allow_pickle=True,fix_imports=True,encoding='latin1')
    ground_truth_detections = np.load(ground_truth_path + "detections_all_faces.npy",allow_pickle=True,fix_imports=True,encoding='latin1')
...
def eval_detections_character(detections, scores, file_names,ground_truth_path,character):
    # ground_truth_file = np.loadtxt(ground_truth_path, dtype='str')
    ground_truth_file_names = np.load(ground_truth_path + "file_names_" + character + ".npy",allow_pickle=True,fix_imports=True,encoding='latin1')
    ground_truth_detections = np.load(ground_truth_path + "detections_" + character + ".npy",allow_pickle=True,fix_imports=True,encoding='latin1')
...
ground_truth_path_root = solution_path_root

#task1
solution_path = solution_path_root + "task1\\"
ground_truth_path = ground_truth_path_root + 'task1_yolo\\'
...
ground_truth_path = ground_truth_path_root + 'task2_yolo\\'
